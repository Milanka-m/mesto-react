...
Проект предоставляет возможность пользователю обновить данные профиля и аватар, добавить на страничку или удалить свою собственную карточку, поставить или снять свой "лайк".
[Ссылка на проект в GitHub Pages](https://milanka-m.github.io/mesto-react/)
